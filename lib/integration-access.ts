...
/** Account that can use draft platform OAuth (TikTok, Instagram, X, Podcasts) before public release. */
export const INTEGRATION_PREVIEW_EMAIL = "jeremiahtaylor91302@gmail.com";

const COMING_SOON_PLATFORMS = new Set<Platform>(["tiktok", "instagram", "twitter", "podcast"]);
